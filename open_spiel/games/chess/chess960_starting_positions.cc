...
constexpr const char* kChess960StartingFens0 =
...
constexpr const char* kChess960StartingFens1 =
    R"(bnrkrbnq/pppppppp/8/8/8/8/PPPPPPPP/BNRKRBNQ w KQkq - 0 1
...
constexpr const char* kChess960StartingFens2 =
    R"(nbbnrkqr/pppppppp/8/8/8/8/PPPPPPPP/NBBNRKQR w KQkq - 0 1
...
constexpr const char* kChess960StartingFens3 =
    R"(rqbkrnnb/pppppppp/8/8/8/8/PPPPPPPP/RQBKRNNB w KQkq - 0 1
...
constexpr const char* kChess960StartingFens4 =
    R"(rnkbbnrq/pppppppp/8/8/8/8/PPPPPPPP/RNKBBNRQ w KQkq - 0 1
...
// fourth part of the string
constexpr const char* kChess960StartingFens5 =
    R"(rkrbnqbn/pppppppp/8/8/8/8/PPPPPPPP/RKRBNQBN w KQkq - 0 1
...
// rbbknqnr/pppppppp/8/8/8/8/PPPPPPPP/RBBKNQNR w KQkq - 0 1
// rbbknqrn/pppppppp/8/8/8/8/PPPPPPPP/RBBKNQRN w KQkq - 0 1
// rbbkrqnn/pppppppp/8/8/8/8/PPPPPPPP/RBBKRQNN w KQkq - 0 1 // first part
...
// nrkbbnrq/pppppppp/8/8/8/8/PPPPPPPP/NRKBBNRQ w KQkq - 0 1
// nrkbbrnq/pppppppp/8/8/8/8/PPPPPPPP/NRKBBRNQ w KQkq - 0 1
// rnnbbkrq/pppppppp/8/8/8/8/PPPPPPPP/RNNBBKRQ w KQkq - 0 1 // second part
...
std::vector<std::string> Chess960StartingPositions() {
  // return absl::StrSplit(kChess960StartingFens, '\n');
    ...
    combined << kChess960StartingFens0 << kChess960StartingFens1 << kChess960StartingFens2 << kChess960StartingFens3 << kChess960StartingFens4 << kChess960StartingFens5;
    return absl::StrSplit(combined.str(), '\n');
}
